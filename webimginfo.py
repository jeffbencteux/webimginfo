...
def exiftool_analysis(filenames):
	...
	for d in metadata:
		...
		# locations
		locations = ["EXIF:GPSLatitude", "EXIF:GPSLongitude", "EXIF:GPSAltitude", "EXIF:GPSLatitudeRef", "EXIF:GPSLongitudeRef", "EXIF:GPSAltitudeRef"]
		print_fields("locations", d, locations)
		...
		dates = ["File:FileModifyDate", "File:FileAccessDate", "File:FileInodeChangeDate", "ICC_Profile:ProfileDateTime", "PNG:Datecreate", "PNG:Datemodify", "PNG:ModifyDate", "XMP:MetadataDate", "XMP:ModifyDate", "XMP:CreateDate", "IPTC:DateSent", "IPTC:TimeSent", "IPTC:DateCreated", "IPTC:TimeCreated", "GPSDateStamp", "GPSTimeStamp"]
